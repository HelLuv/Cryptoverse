  ...
  return (
    <Col className="coin-detail-container">
      ...
      <Select defaultValue="7d"
              ...
              placeholder="Select Period of Time"
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics-heading">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing the statistics of {cryptoDetails.name}, such as the base and quote currency, the
          ...
          {stats.map(({icon, title, value}) => (
            <Col className="coin-stats" key={KeyBuilder.build}>
              ...
              <Text className="stats">{value ?? "0.0"}</Text>
            </Col>
          ))}
        </Col>
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing the statistics of {cryptoDetails.name}, such as the number of markets, exchanges and
